...
func (c *alertServiceClient) GetAlerts(ctx context.Context, in *AlertRequest, opts ...grpc.CallOption) (*AlertResponse, error) {
...
func (UnimplementedAlertServiceServer) GetAlerts(context.Context, *AlertRequest) (*AlertResponse, error) {
...
func _AlertService_GetAlerts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AlertServiceServer).GetAlerts(ctx, req.(*AlertRequest))
	}
